...
from autoop.core.ml.model.regression import MultipleLinearRegression, GradientBoostingRegression, ElasticNetRegression
from autoop.core.ml.model.classification import LogisticRegressionClassifier, RandomForestClassifierModel, SupportVectorClassifier
...
# List of available classification models (to be filled with classification models)
