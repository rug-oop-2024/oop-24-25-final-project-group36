...
class Artifact(BaseModel):
    """
    A base class of an artifact, which stores information about a file or data asset.
    ...
    def read(self) -> Union[bytes, pd.DataFrame]:
        """
        Reads the artifact data. Returns bytes for non-dataset types or DataFrame for dataset types.
        """
        return self.data
    ...
    def id(self) -> str:
        """
        Generates a unique ID for the artifact based on the asset path and version.
        """
